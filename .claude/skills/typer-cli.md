...
Creates or extends Python command-line interfaces using Typer and wires them into 
pyproject.toml entry points.

## When to Use

Use this skill when asked to:
- Add a new CLI command to a Python package
- Add a subcommand to an existing Typer app
- Expose a console script for a Python package
- Update `[project.scripts]` in pyproject.toml
- Initialize a new Python project with CLI support
